        ...
        <div className="flex flex-wrap -m-4 text-center">
          {data.certifications.map((c, index) => (
            <div className="w-full p-2 sm:w-1/2 md:w-1/5 " key={index}>
              <div className={`flex flex-col items-center px-2 py-2 transition duration-300 transform border border-gray-600 rounded-lg shadow-md bg-gray-100/20 hover:scale-105 ${c.shadow}`}>
