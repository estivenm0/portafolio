    ...
    <footer className="w-full px-4 mt-24 md:px-0 ">
        <div className="flex flex-col items-center justify-between leading-relaxed md:flex-row">
            <div className="w-full text-center md:w-1/2 md:text-left">
                ...
                <p className="text-slate-200">Animation and Icons: 
                <a href="https://lottiefiles.com/" target="_blank"  className="underline hover:no-underline text-slate-200 hover:text-gray-300" rel="noopener noreferrer">LottieFiles</a>, <a href="https://cocomaterial.com/" target="_blank"  className="underline hover:no-underline" rel="noopener noreferrer">Coco Material</a>
